...
onAddGcode : function(addGcodeCallback, gcodeParts, eagleWidget, helpDesc){ 
    ...
    addGcodeCallback(1500, myOwnGcode ); 
        ...
        setupFeedsDepths: function() {
            ...
            el.find('.XZero').change(function(evt) {
                console.log("evt:", evt);
        ...
        // use this flag later as checkbox for user to decide
        automaticToolChangeActive: true,
        ...
        touchProbe: function(){
            ...
            // TODO: Think about a toollength sensor, it's easier to handle but he has a 
            // difference between the PCB surface and sensor, this diffence we have 
            // to find at configure our platform and at every new pcb in platform 
            // toolsensor_zero <=> pcb surface as config param
            //  http://www.cnccookbook.com/img/OthersProjects/CNCTouchsetter.jpg
            //  
            // configure:
            //  * touch probe PCB surface
        ...
        toolChange: function(comment, art, tdiameter){
            if(this.toolnumber === undefined || !this.toolnumber)
                this.toolnumber = 0;
            this.toolnumber++;
            ...
            this.tools.push({
                ...
                art:    art,
                dia:    parseFloat(tdiameter).toFixed(1),
            });
        ...
        exportGcodeToolsDatabase:function(){
            var tdb = this.tools;
            var g = "(Tooldatabase for XATC [automatic tool changer])\n";

            tdb.forEach(function(tool){
                g += "(T"+ tool.number +": " + tool.art + " " + tool.dia +")\n";    
            });
        ...
        exportGcodeMilling:function(){
            var g = '';
            g += this.toolChange('set tool to mill isolate signals --url:https://raw.githubusercontent.com/xpix/widget-eagle/master/helpers/tc_signalmill.html--', 'Sink', 0.1);
        ...
        exportGcodeDrillVias:function(){
            ...
            // Drilling, first sort to drill diameter and change tool to first diameter
            g += "(------ DRILLING VIAS -------)\n";
            for ( var diameter in this.sortObjByKey(this.drillVias) ){
               g += this.toolChange('set tool to drill with diameter ' + diameter, 'Drill', diameter);
        ...
        exportGcodeDrillPads:function(){
            ...
            var that = this;
            g += "(------ DRILLING PADS -------)\n";
            for ( var diameter in this.sortObjByKey(this.drillPads)){
        ...
        exportGcodeDimensions:function(){
            ...
            // DIMENSION Milling
            g += "(------ DIMENSION Milling -------)\n";
            g += this.toolChange('Please setup your cutter tool --url:https://raw.githubusercontent.com/xpix/widget-eagle/master/helpers/tc_cutter.html--', 'Mill', diaOfEndmill);
        ...
        exportGcode: function() {
            ...
            i = 150; // Add all registered Tools after GcodeHeader
            this.addGcode(i, this.exportGcodeToolsDatabase());
        ...
        setupUiFromLocalStorage: function () {
            ...
            // get all saved options and try to find a field 
            // to set the saved value for this field
            var el = $('#' + this.id);
